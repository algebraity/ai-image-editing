            ...
            param_schema(
                {
                    ...
                    "tolerance": number_field("Color distance tolerance. Required for rgb; optional fallback for hsv.", minimum=0),
                    "bbox_xyxy": BBOX,
                ...
                description="Use either color or seed_points. Use exclude_seed_points to subtract nearby colors such as skin, cloth, gems, or knots.",
            ),
            target_fields={"layer_id": TF.DEFAULT_ACTIVE_LAYER, "mask_id": TF.GENERATED},
        ),
        spec(
            ...
            param_schema(
                {
                    ...
                    "saturation_tolerance": number_field("HSV saturation tolerance.", minimum=0, maximum=1),
                    "value_tolerance": number_field("HSV value tolerance.", minimum=0, maximum=1),
                    "edge_stop_threshold": number_field("Optional normalized local RGB edge threshold; lower values stop more strongly at borders.", minimum=0),
                    "kind": MASK_KIND,
                    "set_active": bool_field("Make active selection.", default=True),
                },
                required=("seed_points",),
            ),
            target_fields={"layer_id": TF.DEFAULT_ACTIVE_LAYER, "mask_id": TF.GENERATED},
        ),
        spec(
            ...
            param_schema(
                {
                    ...
                    "method": enum_field(("luminance", "set_hue_preserve_lightness", "set_hue_preserve_value", "material_hsl"), "Colorize method.", default="luminance"),
                },
                required=("color",),
            ),
            target_fields={"layer_id": TF.DEFAULT_ACTIVE_LAYER},
...
_COLOR_PARAMS = param_schema(
    {
        ...
        "method": enum_field(("luminance", "average", "lightness", "set_hue_preserve_lightness", "set_hue_preserve_value", "material_hsl"), "Adjustment method."),
